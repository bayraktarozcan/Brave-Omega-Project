...
#                  Brave 1.92.143 (Resmi Derleme) (64 bit) Chromium: 150.0.7871.182
...
#
# !! KANAL UYARISI !!
#    Brave 1.92.143, 23 Temmuz 2026 tarihli, Stable (kararlı) kanalına aittir.
