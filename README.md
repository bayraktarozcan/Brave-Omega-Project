...
[![Brave](https://img.shields.io/badge/Brave-1.94.121%20%7C%20Chromium%20152-FF6000?style=flat-square&logo=brave&logoColor=white)](https://brave.com)
...
Essential ⭐ (51), Balanced (83), Advanced (123), and Strict (151) — giving users precise control over
...
> [!NOTE]
> Brave Omega is validated against the **Stable channel only** (currently Brave 1.94.121 / Chromium 152). ADMX policy behaviors have not been tested on Beta/Nightly builds and may behave differently.
...
> [!NOTE]
> Brave Omega yalnızca **Kararlı (Stable) kanalda** doğrulanmıştır (güncel Brave 1.94.121 / Chromium 152). ADMX politika davranışları Beta/Nightly yapılarında test edilmemiştir ve farklılık gösterebilir.
