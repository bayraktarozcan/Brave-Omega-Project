...
[![Brave](https://img.shields.io/badge/Brave-1.91.180%20%7C%20Chromium%20149-FF6000?style=flat-square&logo=brave&logoColor=white)](https://brave.com)
...
|-------------|---------------|----------|---------|--------|
| **v2.1.4** *(current)* | 1.91.180 | 149 | 11 25H2 | ✅ Active |
...
> [!NOTE]
> Brave Omega is validated against the **Stable channel only** (currently Brave 1.91.180 / Chromium 149). ADMX policy behaviors have not been tested on Beta/Nightly builds and may behave differently.
...
|-------------|--------------|----------|---------|-------|
| **v2.1.4** *(güncel)* | 1.91.180 | 149 | 11 25H2 | ✅ Etkin |
...
> [!NOTE]
> Brave Omega yalnızca **Kararlı (Stable) kanalda** doğrulanmıştır (güncel Brave 1.91.180 / Chromium 149). ADMX politika davranışları Beta/Nightly yapılarında test edilmemiştir ve farklılık gösterebilir.
