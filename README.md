...
[![Brave](https://img.shields.io/badge/Brave-1.92.143%20%7C%20Chromium%20150-FF6000?style=flat-square&logo=brave&logoColor=white)](https://brave.com)
...
> [!NOTE]
> Brave Omega is validated against the **Stable channel only** (currently Brave 1.92.143 / Chromium 150). ADMX policy behaviors have not been tested on Beta/Nightly builds and may behave differently.
...
> [!NOTE]
> Brave Omega yalnızca **Kararlı (Stable) kanalda** doğrulanmıştır (güncel Brave 1.92.143 / Chromium 150). ADMX politika davranışları Beta/Nightly yapılarında test edilmemiştir ve farklılık gösterebilir.
