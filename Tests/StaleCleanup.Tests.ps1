...
Describe "Stale Policy Cleanup - v2.5.4.0" -Tag "Unit" {

    It "should declare v2.5.4.0 in both scripts" {
        (Get-VariableRegex -ScriptPath $ScriptEN -VariableName "ScriptVersion") | Should -Be "v2.5.4.0"
        (Get-VariableRegex -ScriptPath $ScriptTR -VariableName "BetikSurum") | Should -Be "v2.5.4.0"
    }
