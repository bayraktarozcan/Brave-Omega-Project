...
|--------|--------|-----------|
| **Latest stable release (currently v2.5.5.2)** | Active | ✅ Fully supported — security patches, policy updates, feature improvements |
...
│  ↳ 24–150 policies depending on hardening level           │
...
| Dal | Durum | Destek |
|-----|-------|--------|
| **En son kararlı sürüm (şu an v2.5.5.2)** | Aktif | ✅ Tam destek — güvenlik yamaları, politika güncellemeleri, yeni özellikler |
...
│  ↳ Sıkılaştırma seviyesine bağlı olarak 24–150 politika   │
