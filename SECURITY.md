...
│  ↳ 13–68 policies depending on hardening level            │
...
| **Essential ⭐** | 30 (Brave Only + 17) | Brave + zero-impact data leak prevention | None |
| **Balanced** | 46 (Essential + 16) | Full security baseline with minor changes | Low |
| **Strict** | 68 (Balanced + 22) | Maximum privacy preservation | Medium |
...
│  ↳ Sıkılaştırma seviyesine bağlı olarak 13–68 politika    │
...
| **Temel ⭐** | 30 (Brave Yalnız + 17) | Brave + sıfır etkili veri sızıntısı önleme | Yok |
| **Dengeli** | 46 (Temel + 16) | Tam güvenlik temeli, küçük değişiklikler | Düşük |
| **Katı** | 68 (Dengeli + 22) | Azami gizlilik koruması | Orta |
