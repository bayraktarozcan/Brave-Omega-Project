...
|--------|--------|-----------|
| **Latest stable release (currently v2.8.1.0)** | Active | ✅ Fully supported — security patches, policy updates, feature improvements |
...
| Dal | Durum | Destek |
|-----|-------|--------|
| **En son kararlı sürüm (şu an v2.8.1.0)** | Aktif | ✅ Tam destek — güvenlik yamaları, politika güncellemeleri, yeni özellikler |
