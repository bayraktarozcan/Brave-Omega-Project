...
| ------------- | --------------- | ---------- | --------- | -------- |
| **v2.7.3.0** *(current)* | 1.95.104 | 153 | 11 25H2 | ✅ Current |
...
> **Latest Release:** [v2.7.3.0 - Brave 1.95.104 compatibility validation](https://github.com/bayraktarozcan/Brave-Omega-Project/releases/latest)
