...
| 📋 **ADMX-Validated Policies** | 150 ADMX-Validated Policies (5 tiers, 24→52→84→122→150 chain), every entry sourced from Brave's official `policy_templates.zip` |
...
| ------------- | --------------- | ---------- | --------- | -------- |
| **v2.5.5.2** *(current)* | 1.93.136 | 151 | 11 25H2 | ✅ Current |
...
> **Latest Release:** [v2.5.5.2 — Brave 1.93.136 Compatibility](https://github.com/bayraktarozcan/Brave-Omega-Project/releases/latest)
...
| 📋 **ADMX Doğrulamalı Politikalar** | 150 ADMX Doğrulamalı Politika (5 kademe, 24→52→84→122→150 zinciri), her giriş Brave'in resmî `policy_templates.zip` dosyasından kaynaklanmıştır |
...
> **Son Sürüm:** [v2.5.5.2 — Brave 1.93.136 Uyumluluğu](https://github.com/bayraktarozcan/Brave-Omega-Project/releases/latest)
