...
| 📋 **ADMX-Validated Policies** | 110 ADMX-Validated Policies (5 tiers, 24→50→79→96→110 chain), every entry sourced from Brave's official `policy_templates.zip` |
...
| 📋 **ADMX Doğrulamalı Politikalar** | 110 ADMX Doğrulamalı Politika (5 kademe, 24→50→79→96→110 zinciri), her giriş Brave'in resmî `policy_templates.zip` dosyasından kaynaklanmıştır |
