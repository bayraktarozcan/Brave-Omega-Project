...
| ------------- | --------------- | ---------- | --------- | -------- |
| **v2.6.1.1** *(current)* | 1.94.117 | 152 | 11 25H2 | ✅ Current |
...
> **Latest Release:** [v2.6.1.1 — S/MIME documentation correction](https://github.com/bayraktarozcan/Brave-Omega-Project/releases/latest)
...
> **Son Sürüm:** [v2.6.1.1 — S/MIME belgelendirme düzeltmesi](https://github.com/bayraktarozcan/Brave-Omega-Project/releases/latest)
