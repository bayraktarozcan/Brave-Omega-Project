...
| 📋 **ADMX-Validated Policies** | 150 ADMX-Validated Policies (5 tiers, 24→51→82→120→150 chain), every entry sourced from Brave's official `policy_templates.zip` |
...
| 📋 **ADMX Doğrulamalı Politikalar** | 150 ADMX Doğrulamalı Politika (5 kademe, 24→51→82→120→150 zinciri), her giriş Brave'in resmî `policy_templates.zip` dosyasından kaynaklanmıştır |
