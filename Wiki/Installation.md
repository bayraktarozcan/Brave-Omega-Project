...
- Displays level selection menu (1-4) and applies policies based on selected level (23/40/61/82)
...
- Seviye seçim menüsünü gösterir (1-4) ve seçilen seviyeye göre politikaları uygular (23/40/61/82)
