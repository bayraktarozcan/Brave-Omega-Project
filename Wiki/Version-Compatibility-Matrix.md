...
| ------------- | --------------- | ---------- | --------- | -------- | -------------- |
| **v2.8.0.0** ✅ | 1.95.104 | 153.0.8010.53 | Windows 11 25H2 | ✅ Active | 2026-09-22 |
...
| **v2.5.1.0** 📦 | 1.92.143 | 150.0.7871.182 | Windows 11 25H2 | 📦 Previous | 2026-07-23 |
| **v2.5.0.0** 📦 | 1.92.141 | 150.0.7871.128 | Windows 11 25H2 | 📦 Previous | 2026-07-21 |
| **v2.4.2.0** | 1.92.141 | 150.0.7871.128 | Windows 11 25H2 | 📦 Previous | 2026-07-21 |
| **v2.4.1.0** | 1.92.139 | 150.0.7871.114 | Windows 11 25H2 | 📦 Previous | 2026-07-12 |
| **v2.4.0.0** | 1.92.139 | 150.0.7871.114 | Windows 11 25H2 | 📦 Previous | 2026-07-11 |
| **v2.3.1.0** | 1.92.139 | 150.0.7871.114 | Windows 11 25H2 | 📦 Previous | 2026-07-10 |
...
| **v2.1.5.0** | 1.92.134 | 150.0.7871.63 | Windows 11 25H2 | 📦 Previous | 2026-07-03 |
...
### Use Current (v2.8.0.0) If

- Running Brave 1.95.104 (latest stable)
...
### Use Previous (v2.7.3.0) If

- Cannot update to v2.8.0.0 immediately
...
- Policies outdated (only 7 vs 151 current)
...
| v2.6.1.0 | 151 | 100% | Clean-up release — Device attributes clean-up (2026-08-31). 1 policy removed (152→151): ChromeOS-only `DeviceAttributesAllowedForOrigins` unsupported by Brave on Windows. No Windows hardening lost across all 5 tiers |
| v2.6.0.0 | 152 | 100% | Feature release — Microsoft S/MIME for OWA (Chromium 152.0.7977.64). 2 new policies (150→152): S/MIME native messaging host (Advanced), OWA S/MIME extension allow-list (Balanced+). No regressions across all 5 tiers |
...
| v2.5.2.0 | 150 | 100% | Compatibility validation: Brave 1.92.144 (Chromium 150.0.7871.186). No policy changes |
...
| ------------- | -------------- | ---------- | --------- | ------- | -------------- |
| **v2.8.0.0** ✅ | 1.95.104 | 153.0.8010.53 | Windows 11 25H2 | ✅ Etkin | 2026-09-22 |
...
| **v2.5.1.0** 📦 | 1.92.143 | 150.0.7871.182 | Windows 11 25H2 | 📦 Önceki | 2026-07-23 |
| **v2.5.0.0** 📦 | 1.92.141 | 150.0.7871.128 | Windows 11 25H2 | 📦 Önceki | 2026-07-21 |
| **v2.4.2.0** | 1.92.141 | 150.0.7871.128 | Windows 11 25H2 | 📦 Önceki | 2026-07-21 |
| **v2.4.1.0** | 1.92.139 | 150.0.7871.114 | Windows 11 25H2 | 📦 Önceki | 2026-07-12 |
| **v2.4.0.0** | 1.92.139 | 150.0.7871.114 | Windows 11 25H2 | 📦 Önceki | 2026-07-11 |
| **v2.3.1.0** | 1.92.139 | 150.0.7871.114 | Windows 11 25H2 | 📦 Önceki | 2026-07-10 |
...
| **v2.1.5.0** | 1.92.134 | 150.0.7871.63 | Windows 11 25H2 | 📦 Önceki | 2026-07-03 |
...
### Güncel (v2.8.0.0) Kullan Eğer

- Brave 1.95.104 (en güncel kararlı) çalışıyorsa
...
### Önceki (v2.7.3.0) Kullan Eğer

- Hemen v2.8.0.0'a güncelleyemiyorsanız
...
- Politikalar güncel değil (7'ye karşı 151)
...
| v2.6.1.0 | 151 | 100% | Temizlik sürümü — Cihaz Öznitelikleri temizliği (2026-08-31). 1 politika kaldırıldı (152→151): Windows'ta Brave tarafından desteklenmeyen yalnızca ChromeOS'a özgü `DeviceAttributesAllowedForOrigins`. 5 seviyede de Windows sıkılaştırması kaybı yok |
| v2.6.0.0 | 152 | 100% | Özellik sürümü — OWA için Microsoft S/MIME (Chromium 152.0.7977.64). 2 yeni politika (150→152): S/MIME yerel mesajlaşma ana bilgisayarı (Gelişmiş), OWA S/MIME uzantı izin listesi (Dengeli+). 5 seviyede de gerileme gözlenmedi |
...
| v2.5.2.0 | 150 | 100% | Uyumluluk doğrulaması: Brave 1.92.144 (Chromium 150.0.7871.186). Politika değişikliği yok |
